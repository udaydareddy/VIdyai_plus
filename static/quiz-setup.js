...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function selectOption(optionElement, optionIndex) {
        ...
        if (optionIndex === correctOptionIndex) {
            ...
            // Add to weak areas (based on question topic)
            const questionText = currentQuestion.question.toLowerCase();
            
            // Extract potential topic from the question
            // This is a simplified approach - in a real app, you might tag questions with topics
